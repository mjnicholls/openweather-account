  ...
  return (
    <div>
      <div className="d-flex align-items-center justify-content-between" onClick={() => setOpen(!open)} >
        ...
        <div className="d-lg-none" style={{borderBottom: !open ? "1px solid #ced4da" : ""}}></div>
        <img className="d-lg-none" src={icon_down_black} alt="arrow" style={{transform: open ? "rotate(180deg)" : "none"}}/>
      </div>

      <div className="d-lg-none" style={{display: open ? "block" : "none", borderBottom: open ? "1px solid #ced4da" : ""}}>{props.children}</div>
